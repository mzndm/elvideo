...
(function(factory) {
    ...
    var defaults = {
        ...
        width: 10,          // width of a digit area
    ...
    var dictionary = {
        ...
        ru:{days:'дня',   hours:'часа',  min:'минут',    sec:'секунд'},
    ...
    $.fn.timeTo = function() {
        ...
        return this.each(function() {
            ...
            if(!data.vals) { // new clock
                ...
                data.height = Math.round(data.fontSize * 100 / 94) || data.height;
                data.width = Math.round(data.fontSize * 0.55 + data.height * 0.13) || data.width;
                ...
                var left = Math.round(data.height / 10),
                    ...
                    dot2 = '<span></span>',
                    maxWidth = Math.round(data.width * 4 + 20),
                ...
                if(data.displayDays > 0) {
                    ...
                    thtml = (data.displayCaptions ?
                        '<figure style="max-width:'+ Math.round(data.width*data.displayDays + marginRight + 46) +'px">$1'
